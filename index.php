...
<body style="background-size: 100% ;font-family: Times New Roman" class="bg-gradient-seconday">
...
<div class="row w-100" >
  ...
  <h4 class="display-5 ">Welcome to TISHA BANK</h4>
  <p  class="lead alert alert-info"><b> Notification:</b>
     ...
     ?></p>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-2 rounded-1 shadowBlack" data-ride="carousel" >
          ...
          <div class="carousel-item active">
            <img class="d-block w-100" src="images/TISHA BANK1.gif" alt="First slide" style="max-height: 250px">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="images/money.jpeg" alt="Second slide" style="max-height: 250px">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="images/bank.jpeg" alt="Third slide" style="max-height: 250px">
          </div>
    ...
    <div class="row" style="padding: 22px;padding-top: 0">
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/accounting.jpg" style="max-height: 155px;min-height: 155px" alt="Card image cap">
          <div class="card-body">
