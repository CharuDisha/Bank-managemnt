...
<head>
  ...
  {
    if ($con->query("delete from useraccounts where userId = '$_GET[delete]'"))
    {
...
<div class="card w-100 text-center shadowBlue">
  ...
  <div class="card-body">
   <table class="table table-bordered table-sm alert alert-dark">
  <thead>
    <tr>
      <th scope="col">#</th>
  ...
  <tbody>
    ...
    ?>
      <tr>
        ...
        <td>
          <a href="show.php?id=<?php echo $row['userId'] ?>" class='btn btn-success btn-sm' data-toggle='tooltip' title="View More info">View</a>
          <a href="mnotice.php?id=<?php echo $row['userId'] ?>" class='btn btn-info btn-sm' data-toggle='tooltip' title="Send notice to account">Send Notice</a>
