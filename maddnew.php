...
<body style="background: url(images/home2.jpeg);background-size: 125% ;font-family: Times New Roman" class="bg-gradient-seconday">
 ...
 <a class="navbar-brand" href="#">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto ">
      ...
      <li class="nav-item active">  <a class="nav-link" href="maddnew.php">Create Account</a></li>
  ...
  <div class="card-body alert alert-dark">
    <table class="table">
      <tbody>
        ...
        <tr>
          <td colspan="4">
            <button type="submit" name="saveAccount" class="btn btn-info btn-sm">Save Account</button>
